...
func TestClassifyFileNoise(t *testing.T) {
	cases := []struct {
		...
		{`C:\Windows\System32\CatRoot2\{f750e6c3}\tmp.cat`, "tmp.cat", "os_telemetry"},
		{`C:\Windows\System32\DriverStore\FileRepository\x\y.inf`, "y.inf", "os_telemetry"},
		{`C:\Users\analyst\AppData\Local\Packages\Microsoft.Foo\LocalState\a.dat`, "a.dat", "os_telemetry"},
		{`C:\Users\analyst\Downloads\QuarantineLabTest\marker.txt`, "marker.txt", ""},
